...
class ElectricDataset(Dataset):
    def __init__(self, df, input_len=90, pred_len=365):
...
class LSTMPredictorWithFreq(nn.Module):
    def __init__(self, input_size, hidden_size=128, num_layers=3, output_len=365, dropout=0.2):
        super().__init__()
...
# ========== 主函数 ==========
def main(train_path, test_path, input_len=90, pred_len=365, epochs=200, batch_size=32, loss_type="combined"):
